...
public class panelRollo extends JPanel implements ActionListener{
	...
	public panelRollo()
	{
		...
		panelDescDisc.setLayout(new GridLayout(6,2));
	...
	public void inicializar(rollo rol)
	{
		ArrayList si = rol.getrolltu();
