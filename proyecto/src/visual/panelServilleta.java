...
public class panelServilleta extends JPanel implements ActionListener{
	...
	public panelServilleta()
	{
		...
		butSiguienteSemana.setActionCommand(">>");
		butAnteriorSemana.setActionCommand("<<");
		butsiguiente.setActionCommand("Siguiente");
		butAnterior.setActionCommand("Anterior");
		
		butSiguienteSemana.addActionListener(this);
		butAnteriorSemana.addActionListener(this);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getActionCommand().equals(">>"))
		{
			...
			if(semana!= null)
			{
				...
				{
					cc=cc+1;
					Semana semi = (Semana)semana.get(cc);
					 txtEntrada.setText(semi.getEntrada());
					 txtSalida.setText(semi.getSalida());
					 txtStock.setText(semi.getStock());;
				}
			}
		...
		else if(arg0.getActionCommand().equals("Anterior"))
		{
			if(c2!=0)
			{
				c2=c2-1;
		...
		{
			if(c2!=servil.getservilletatu().size()-1)
			{
				c2=c2+1;
				inicializar2(servil);
			}
	...
	public void inicializar(servilleta serv)
	{
		servil = serv;
		c2 = 0;
		ArrayList si = serv.getservilletatu();
	...
	public void inicializar2(servilleta serv)
	{
		servil = serv;
		ArrayList si = serv.getservilletatu();
		ArrayList s = (ArrayList) si.get(c2);
		Descripcion desc = (Descripcion) s.get(0);
		consumoProducto cP = (consumoProducto) s.get(1);
		calculoNivelR cN = (calculoNivelR) s.get(2);
		semana = (ArrayList) s.get(3);
